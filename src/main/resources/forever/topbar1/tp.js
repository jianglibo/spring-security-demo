...
(function (window, document) {
	...
	var canvas,
		...
		createCanvas = function () {
			...
			style.zIndex = 100001;
			style.display = "none";
			// add attribute to canvas element.
			// canvas.setAttribute("hx-history", "false");
			canvas.setAttribute("id", "topbar-canvas");
		...
		topbar = {
			...
			show: function (delay) {
				...
				if (delay) {
					...
					if (!document.querySelector("#topbar-canvas")) createCanvas();
